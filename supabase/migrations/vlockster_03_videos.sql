...
-- Indexes for videos
CREATE INDEX IF NOT EXISTS idx_videos_uploader ON public.profiles;
CREATE INDEX IF NOT EXISTS idx_videos_visibility ON public.profiles;
CREATE INDEX IF NOT EXISTS idx_videos_tags ON public.profiles;
CREATE INDEX IF NOT EXISTS idx_videos_featured ON public.profiles;
CREATE INDEX IF NOT EXISTS idx_videos_published ON public.profiles;

-- Indexes for metrics
CREATE INDEX IF NOT EXISTS idx_video_metrics_video ON public.profiles;
CREATE INDEX IF NOT EXISTS idx_video_metrics_viewer ON public.profiles;
CREATE INDEX IF NOT EXISTS idx_video_metrics_completed ON public.profiles;
