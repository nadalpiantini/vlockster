...
CREATE INDEX IF NOT EXISTS idx_communities_owner ON public.profiles;
CREATE INDEX IF NOT EXISTS idx_communities_private ON public.profiles;

-- Indexes for memberships
CREATE INDEX IF NOT EXISTS idx_memberships_community ON public.profiles;
CREATE INDEX IF NOT EXISTS idx_memberships_user ON public.profiles;

-- Indexes for posts
CREATE INDEX IF NOT EXISTS idx_posts_community ON public.profiles;
CREATE INDEX IF NOT EXISTS idx_posts_user ON public.profiles;
CREATE INDEX IF NOT EXISTS idx_posts_pinned ON public.profiles;
CREATE INDEX IF NOT EXISTS idx_posts_created ON public.profiles;

-- Indexes for comments
CREATE INDEX IF NOT EXISTS idx_comments_post ON public.profiles;
CREATE INDEX IF NOT EXISTS idx_comments_user ON public.profiles;
CREATE INDEX IF NOT EXISTS idx_comments_parent ON public.profiles;

-- Indexes for likes
CREATE INDEX IF NOT EXISTS idx_post_likes_post ON public.profiles;
CREATE INDEX IF NOT EXISTS idx_post_likes_user ON public.profiles;
CREATE INDEX IF NOT EXISTS idx_comment_likes_comment ON public.profiles;
CREATE INDEX IF NOT EXISTS idx_comment_likes_user ON public.profiles;
