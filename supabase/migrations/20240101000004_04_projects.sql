...
-- Indexes for rewards
CREATE INDEX IF NOT EXISTS idx_rewards_project ON public.rewards(project_id);
CREATE INDEX IF NOT EXISTS idx_rewards_position ON public.rewards(project_id, position);
...
CREATE INDEX IF NOT EXISTS idx_backings_payment_status ON public.backings(payment_status);
