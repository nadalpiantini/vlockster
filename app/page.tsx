    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white">
      ...
      <section className="py-20 px-4 bg-black/50">
        <div className="container mx-auto">
          <h2 className="text-4xl font-bold text-center mb-12">Three Platforms in One</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 rounded-lg bg-gray-900/50 border border-gray-800 hover:border-red-500/50 transition-colors">
              <Film className="w-16 h-16 mx-auto mb-4 text-red-500" />
              <h3 className="text-2xl font-semibold mb-4">Streaming</h3>
            ...
            <div className="text-center p-8 rounded-lg bg-gray-900/50 border border-gray-800 hover:border-red-500/50 transition-colors">
              <DollarSign className="w-16 h-16 mx-auto mb-4 text-red-500" />
              <h3 className="text-2xl font-semibold mb-4">Crowdfunding</h3>
              <p className="text-gray-400 mb-6">
